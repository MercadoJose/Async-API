...
public class EmployeeDataController {
	...
	public EmployeeProfile getEmployeeProfiles() {
		...
		EmployeeProfile employeeProfile = new EmployeeProfile();
		{
			...
			profileList.add("Back-End JavaScript");
			profileList.add("Front-End React");
			profileList.add("Back-End .NET");
			profileList.add("Front-End Vue");

			employeeProfile.setProfiles(profileList);
		}
